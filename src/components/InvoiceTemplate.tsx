  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
        ...
        <div>
          ...
          <div className="space-y-2 text-[#11254A]/80">
            ...
            <div className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-[#26A395]" />
            ...
            <div className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-[#26A395]" />
              <span>billing@techcorp.com</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-[#26A395]" />
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-8">
        <Card className="border-[#26A395]/20">
          <CardContent className="p-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Calendar className="h-4 w-4 text-[#26A395]" />
        ...
        <Card className="border-[#0E9EA9]/20">
          <CardContent className="p-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Calendar className="h-4 w-4 text-[#0E9EA9]" />
      ...
      <Card className="mb-6">
        <CardContent className="p-0">
          <Table>
            <TableHeader>
              <TableRow className="bg-[#26A395]/10">
            ...
            <TableBody>
              {invoiceItems.map((item, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-right font-medium text-[#26A395]">
      ...
      <div className="flex justify-end mb-8">
        <div className="w-full max-w-sm">
          <div className="space-y-2">
            ...
            <Separator />
            <div className="flex justify-between text-lg font-bold text-[#26A395]">
              <span>Total:</span>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <Card className="border-[#26A395]/20">
          <CardContent className="p-6 text-center">
            ...
            <div className="bg-white border-2 border-[#26A395]/20 rounded-lg p-4 mb-4 inline-block">
        ...
        <Card className="border-[#0E9EA9]/20">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="flex items-center space-x-2 p-2 bg-white rounded border border-[#26A395]/10">
                <CreditCard className="h-5 w-5 text-[#26A395]" />
                <span className="text-sm text-[#11254A]">Cards</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-white rounded border border-[#26A395]/10">
                <Wallet className="h-5 w-5 text-[#26A395]" />
                <span className="text-sm text-[#11254A]">Digital Wallets</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-white rounded border border-[#26A395]/10">
                <Building className="h-5 w-5 text-[#26A395]" />
                <span className="text-sm text-[#11254A]">Bank Transfer</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-white rounded border border-[#26A395]/10">
                <Banknote className="h-5 w-5 text-[#26A395]" />
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-[#26A395]/10 text-[#26A395] rounded text-xs font-medium">
                  PayPal
                </span>
                <span className="px-2 py-1 bg-[#26A395]/10 text-[#26A395] rounded text-xs font-medium">
                  Stripe
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-3 text-[#11254A]/80">
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-[#26A395] text-white rounded-full flex items-center justify-center text-xs font-bold mt-0.5">
                1
              </div>
              <div>
            ...
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-[#0E9EA9] text-white rounded-full flex items-center justify-center text-xs font-bold mt-0.5">
                2
              </div>
              <div>
            ...
            <div className="mt-4 p-3 bg-[#26A395]/10 rounded-lg">
              <p className="text-sm text-[#26A395] font-medium">
      ...
      {/* Footer */}
      <div className="text-center mt-8 pt-6 border-t border-[#26A395]/20">
