...
const quickActions = [
  ...
  },
  {
    ...
    className: "bg-[#0E9EA9] hover:bg-[#0E9EA9]/90 text-white",
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    variant: "outline" as const,
    className:
      "border-[#26A395] text-[#26A395] hover:bg-[#26A395] hover:text-white",
  },
  {
    icon: Users,
    label: "Add Customer",
    ...
    variant: "outline" as const,
    className:
      "border-[#0E9EA9] text-[#0E9EA9] hover:bg-[#0E9EA9] hover:text-white",
  },
];
