  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-[#26A395] mb-2">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="space-y-2 text-[#11254A]/80">
            ...
            <div className="flex items-center gap-2">
              <TrendingUp className="h-4 w-4 text-[#0E9EA9]" />
              <span>
        ...
        <Card className="border-[#26A395]/20">
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-[#26A395]">
        ...
        <Card className="border-[#0E9EA9]/20">
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-[#0E9EA9]">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-[#26A395]/10 rounded">
                <span className="text-[#11254A]">Current (0-30 days)</span>
                <span className="font-bold text-[#26A395]">$2,350</span>
              </div>
              <div className="flex justify-between p-3 bg-[#0E9EA9]/10 rounded">
                <span className="text-[#11254A]">31-60 days</span>
                <span className="font-bold text-[#0E9EA9]">$2,000</span>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center mb-4">
              <div className="bg-white border-2 border-[#26A395]/20 rounded-lg p-3 mb-3 inline-block">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                <div className="flex items-center space-x-2 p-2 bg-[#F1F2F4] rounded border">
                  <CreditCard className="h-4 w-4 text-[#26A395]" />
                  <span className="text-xs text-[#11254A]">Cards</span>
                </div>
                <div className="flex items-center space-x-2 p-2 bg-[#F1F2F4] rounded border">
                  <Wallet className="h-4 w-4 text-[#26A395]" />
                  <span className="text-xs text-[#11254A]">Wallets</span>
                </div>
                <div className="flex items-center space-x-2 p-2 bg-[#F1F2F4] rounded border">
                  <Building className="h-4 w-4 text-[#26A395]" />
                  <span className="text-xs text-[#11254A]">Bank Transfer</span>
                </div>
                <div className="flex items-center space-x-2 p-2 bg-[#F1F2F4] rounded border">
                  <Banknote className="h-4 w-4 text-[#26A395]" />
              ...
              <div className="flex flex-wrap justify-center gap-1 mb-4">
                <span className="px-2 py-1 bg-[#26A395]/10 text-[#26A395] rounded text-xs">
                  PayPal
                </span>
                <span className="px-2 py-1 bg-[#26A395]/10 text-[#26A395] rounded text-xs">
                  Stripe
      ...
      {/* Footer */}
      <div className="text-center pt-6 border-t border-[#26A395]/20">
