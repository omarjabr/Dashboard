...
export function ClientReceiptTemplate() {
  return (
    <div className="max-w-lg mx-auto p-6 bg-white">
      ...
      {/* Receipt Header */}
      <Card className="mb-6 border-[#26A395]/20">
        <CardContent className="p-4">
          <div className="text-center mb-4">
            <h2 className="text-2xl font-bold text-[#26A395]">
              CLIENT RECEIPT
            </h2>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-[#0E9EA9]" />
      ...
      {/* Client Information */}
      <Card className="mb-6 border-[#0E9EA9]/20">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-3">
            <User className="h-4 w-4 text-[#0E9EA9]" />
            ...
            {serviceDetails.map((item, index) => (
              <div key={index}>
                <div className="flex justify-between items-start mb-1">
                  ...
                  <p className="font-bold text-[#26A395]">${item.amount}</p>
                </div>
      ...
      <Card className="mb-6 bg-[#F1F2F4] border-none">
        <CardContent className="p-4">
          ...
          <div className="text-sm space-y-1 text-[#11254A]/80">
            ...
            <div className="flex items-center gap-2">
              <Mail className="h-3 w-3 text-[#26A395]" />
              <span>m.chen@neo.com</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone className="h-3 w-3 text-[#26A395]" />
      ...
      {/* Footer */}
      <div className="text-center pt-4 border-t border-[#26A395]/20">
      ...
      <Card className="mt-4 border-[#26A395]/20">
        <CardContent className="p-4 text-center">
          <h3 className="font-bold text-[#11254A] mb-3">
            Book Future Services
          </h3>
          <div className="bg-white border border-[#26A395]/20 rounded p-2 mb-3 inline-block">
