            ...
            <div className="space-y-6">
              <div className="grid gap-4 md:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-[#26A395]">
                      {leads.length}
                    </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-[#0E9EA9]">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-[#11254A] flex items-center gap-2">
                    <UserPlus className="h-5 w-5 text-[#26A395]" />
                    Leads Database
                  </CardTitle>
                  <CardDescription>
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Progress
                                ...
                                className="h-2 w-16"
                              />
                              <span className="text-sm font-medium text-[#26A395]">
                                {lead.score}
                              </span>
                            </div>
                          </TableCell>
            ...
            <div className="space-y-6">
              <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-[#26A395]">65%</div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-[#11254A] flex items-center gap-2">
                    <Target className="h-5 w-5 text-[#0E9EA9]" />
                    Opportunities Pipeline
                  </CardTitle>
                  <CardDescription>
                    ...
                    <TableBody>
                      {opportunities.map((opp) => (
                        <TableRow key={opp.id}>
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Target className="h-4 w-4 text-[#0E9EA9]" />
                              <div>
                                <p className="font-medium text-[#11254A]">
                                  {opp.name}
                                </p>
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Progress
                                ...
                                className="h-2 w-16"
                              />
                              <span className="text-sm font-medium text-[#0E9EA9]">
                                {opp.probability}%
                              </span>
                            </div>
                          </TableCell>
