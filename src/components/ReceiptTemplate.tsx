    ...
    <div className="max-w-md mx-auto p-6 bg-white">
      ...
      <Card className="mb-6 border-[#26A395]/20">
        <CardContent className="p-4">
          <div className="text-center mb-4">
            <h2 className="text-2xl font-bold text-[#26A395]">RECEIPT</h2>
      ...
      <Card className="mb-6 border-[#11254A]/20">
        <CardContent className="p-4">
          ...
          <p className="text-sm text-[#26A395] mt-1">✓ Payment Successful</p>
        </CardContent>
      </Card>
      ...
      <Card className="mt-4 border-[#26A395]/20">
        <CardContent className="p-4 text-center">
          ...
          <div className="bg-white border border-[#26A395]/20 rounded p-2 mb-2 inline-block">
          ...
          <div className="flex justify-center flex-wrap gap-1">
            <span className="px-1.5 py-0.5 bg-[#26A395]/10 text-[#26A395] rounded text-xs">
              PayPal
            </span>
            <span className="px-1.5 py-0.5 bg-[#26A395]/10 text-[#26A395] rounded text-xs">
              Stripe
